...
public class GUIController implements ScreenController {
    ...
    public void updatePlayerInfo() {
        ...
        playerNameText.getRenderer(TextRenderer.class).setText("Player: " + playerName);
        towerCountText.getRenderer(TextRenderer.class).setText("Towers: " + playerTowerCount);
        playerColorText.getRenderer(TextRenderer.class).setText("Color: " + playerColor);
        scoreText.getRenderer(TextRenderer.class).setText("Points: " + playerPoints);
    }
